...
module trustless_contracts::multi_input;
...
const ESlotLengthMismatch: u64 = 100;
const EEmptySlots: u64 = 101;
const EUnknownSlot: u64 = 102;
const ESlotFull: u64 = 103;
const EContractComplete: u64 = 104;
const EDescriptionEmpty: u64 = 105;
const EDuplicateSlot: u64 = 106;
const EContractNotComplete: u64 = 107;
...
public fun create<C>(
    ...
    contract_utils::assert_nonzero_escrow(bounty_coin.value());
    ...
    while (i < type_ids.length()) {
        ...
        contract_utils::assert_nonzero_quantity(required);
...
public fun cancel<C>(
    ...
    contract_utils::return_or_destroy_balance(bounty, poster_address, ctx);
