 ...
 * from the Stillness World API. Tuple format: [id, name, x, y, z] where
 * coordinates are string-encoded integers (can exceed MAX_SAFE_INTEGER).
 *
...
type RawTuple = [number, string, string, string, string];
